...
sudo pacman -S zsh sshfs picom nitrogen fzf xorg-xset rofi ranger gnome gvim evince playerctl dunst flameshot
yay -S nerd-fonts-complete oh-my-zsh-git auto-cpufreq google-chrome vim-plug slack
chsh --shell /bin/zsh
